...
export async function up(knex: Knex): Promise<void> {
  return knex.schema
    .createTable('wallets', function (table) {
      ...
      table.decimal('available_balance', 19, 2).defaultTo(0);
      table.decimal('pending_debit_balance', 19, 2).defaultTo(0);
      table.decimal('pending_credit_balance', 19, 2).defaultTo(0);
